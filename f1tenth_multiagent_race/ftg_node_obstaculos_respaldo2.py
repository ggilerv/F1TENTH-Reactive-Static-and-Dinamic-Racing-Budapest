...
obstáculos estáticos (velocidad_max=15.0, cono de proximidad frontal)
==========================================================================

Autor: George Gabriel Giler Vega

Copia de respaldo de `ftg_node_obstaculos.py`, congelada en la versión
validada en 787.9 m recorridos en 3 minutos de prueba continua, sin
choques ni acercamientos peligrosos (velocidad_max=15.0, a_lat_max=5.8,
frenado por proximidad limitado a un cono frontal de 100° en vez de los
180° completos del LiDAR). Se conserva sin cambios como punto de
referencia antes de intentar velocidades aún mayores en
`ftg_node_obstaculos.py`.
...
class FollowTheGapObstaculosRespaldo2(Node):
    ...
    def __init__(self):
        ...
        super().__init__('follow_the_gap_obstaculos_respaldo2')
        ...
        self.declare_parameter('velocidad_max', 15.0)
        ...
        self.declare_parameter('max_aceleracion', 6.5)
...
def main(args=None):
    ...
    nodo = FollowTheGapObstaculosRespaldo2()
    try:
        rclpy.spin(nodo)
